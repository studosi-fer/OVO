...
public class ColorVector {
 ...
 /**
   *
   * Ispravlja prijelaze boja preko jedinice ili ispod nule. Ako se to dogodi,
   * brojevi se zaokruzuju na najvisu, odnosno najmanju vrijednost.
   */

    public void correct(){

    	//boje su u rasponu 0-1
