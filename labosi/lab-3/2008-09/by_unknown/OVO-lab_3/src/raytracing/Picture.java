...
public class Picture extends JFrame {
  ...
  public void paint(Graphics g) {
	  // osnovni pseudokod raytrace funkcije
    for (int j=0; j<this.screenResolution; j++) {
      for (int i=0; i<this.screenResolution; i++) {
    	  //za svaki pixel nabavlja toèku ekrana 
    	  //napravi zraku kroz tu toèku s poèetkom u "oku" promatraèa
        Point screenPoint=screen.getPoint(i,j);
        ray=new Ray(eyePosition, screenPoint);
        // pozivanje same raytrace funkcije i bojanje toèke
