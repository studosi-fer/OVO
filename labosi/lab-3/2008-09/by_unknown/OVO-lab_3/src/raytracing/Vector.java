...
/**
  ...
  public Vector getReflectedVector(Vector N) {
	  //odbijeni vektor se raèuna pomoæu formule R=(2U*N)*N-U
  ...
  public Vector getRefractedVector(Vector N, double nI) {
	  ...
	  //koeficijenti a i b se raèunaj preko formula iz snellovog zakona
	  //b=n1/n2, za zrak n2=1
	  //a=(-2*b*cosA+sqrt(D))/2
	  ...
	  //refraktirana zraka se raèuna pomoæu formule R=-a*N-b*U
